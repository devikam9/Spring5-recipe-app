...
import guru.springframework.spring5_recipe_app.Repository.CategoryRepository;
import guru.springframework.spring5_recipe_app.Repository.RecipeRepository;
import guru.springframework.spring5_recipe_app.Repository.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public List<Recipe> getRecipes() {
        ...
        System.out.println(unitOfMeasureRepository);
